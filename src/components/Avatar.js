...
import {
    ...
    View,
    Image,
    TouchableWithoutFeedback, PixelRatio, Platform
} from 'react-native';
    ...
    renderNetwork = () => {
        ...
        switch (network) {
            ...
            case "reddit":
                ...
                break;
            case "internal":
                Icon = <Image  style={iconStyle}  resizeMode={"contain"} source={require('../assets/images/tipbot.png')} />;
                backgroundColor = "#1DA1F2";
                break;
        }
                ...
                <View style={[{
                    ...
                    <View style={{
                        ...
                        <Animated.Image
                            resizeMode='cover'
                            style={{
                                width: AppSizes.screen.width * 0.10,
                                height: AppSizes.screen.width * 0.10,
                                borderRadius : Platform.OS === "android" ? PixelRatio.getPixelSizeForLayoutSize(20): 0
                            }}
                            source={this.props.source ? this.props.source : require('../assets/images/placeholder.user.png')}
