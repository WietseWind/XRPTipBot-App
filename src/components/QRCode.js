    ...
    renderLogo: function(size) {
        return (
            <View style={[styles.logoContainer]}>
                ...
                >
                    <Image
                        style={[styles.logo, { width: size * 0.25, height: size * 0.25 }]}
                        source={require('../assets/images/icon-jar.png')}
                    />
                </View>
            </View>
        );
            ...
            >
                <View
                    style={{
                        ...
                        borderRadius: 15,
                        borderWidth: 5,
                        borderColor: AppColors.brand.light,
                        overflow: 'hidden',
                    }}
                >
                    <Canvas
                ...
                {this.props.logo && this.renderLogo(size)}
            </ViewShot>
        );
    },
});
