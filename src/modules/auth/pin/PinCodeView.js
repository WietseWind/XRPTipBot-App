...
class PinCodeView extends Component {
    ...
    pinLogin = (pin) => {
        ...
        this.props.pinLogin(paperToken, pin).then(() => {
                ...
                return(
                    ...
                    >
                        <View style={[AppStyles.flex1, AppStyles.centerAligned]}>
                            <Text style={[AppStyles.h5, {textAlign: "center", color: AppColors.brand.light, marginRight: 10, marginLeft: 10}]}>Please enter your account PIN code to login to your account. This is the PIN you selected when you activated your account for the first time.</Text>
                        </View>
            ...
            case "set_confirm":
                return(
                    ...
                    >
                        ...
                        <View style={[AppStyles.flex1, AppStyles.centerAligned]}>
                            <Text style={[AppStyles.h5, {textAlign: "center", color: AppColors.brand.light,  marginRight: 10, marginLeft: 10}]}>Please configure the PIN code for your new account. Please store your PIN in a secure place. You need to enter this PIN if your ever want to withdraw your XRP.</Text>
