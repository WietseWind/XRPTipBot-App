            ...
            case "scan":
                return(
                    <View style={[AppStyles.container]}>
                        ...
                        <View style={[{height: AppSizes.screen.height * 0.15 , width: AppSizes.screen.width}, AppStyles.centerAligned, { backgroundColor: AppColors.brand.primary}]}>
                            <Text numberOfLines={2} style={[AppStyles.h5, { marginRight: 10 , marginLeft: 10 , color: AppColors.brand.light, textAlign: "center"}]}>Please visit xrptipbot.com and go to Login. Select "Paper account", and scan the QR code.</Text>
                        </View>
                        {isLoading &&
                ...
                return(
                    ...
                    >
                        <View style={[AppStyles.flex1, AppStyles.centerAligned]}>
                            <Text style={[AppStyles.h5, {textAlign: "center", color: AppColors.brand.light}]}>Please enter your account PIN code to login.</Text>
                        </View>
