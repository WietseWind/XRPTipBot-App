...
import {
    ...
    Image,
    Linking,
    Platform, TouchableOpacity, Vibration
} from 'react-native';
...
const styles = StyleSheet.create({
    ...
    animation: {
        width:  AppSizes.screen.widget * 0.50,
...
class IntroView extends React.Component {
    ...
    handleDeepLinkLogin = (token) => {
        ...
        if (token) {
            ...
            this.props.login(token, true).then(() => {
            ...
            return (
                ...
                >
                    ...
                    <View style={[AppStyles.flex4, AppStyles.centerAligned]}>
                        <Image style={styles.image} resizeMode={'contain'} source={require('../../assets/images/tipbot.png')}/>
                    </View>

                    <View style={[{flex: 2}, AppStyles.centerAligned]}>
                        <Text style={styles.title}>Welcome to XRP Tip Bot</Text>
                        <Text style={styles.text}>Use your <Text style={AppStyles.link} onPress={() => {_goToURL()}}>xrptipbot.com</Text> account to activate the app, or scan your pairing QR code.</Text>
